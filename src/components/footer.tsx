          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
              ...
              <div>
                ...
                <p className="text-xs mt-2">বাংলাদেশ জামায়াতে ইসলামীর কেন্দ্রীয় মজলিসে শূরা সদস্য, চট্টগ্রাম মহানগরী জামায়াতের সেক্রেটারি ও চট্টগ্রাম-২( ফটিকছড়ি) সংসদীয় আসনের এমপি প্রার্থী ।</p>
