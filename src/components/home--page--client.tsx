      ...
      <section className="bg-white dark:bg-gray-900 pt-12 md:pt-16 font-headline">
        <div className="container mx-auto -mt-[200px] relative z-10">
          ...
          >
            ...
            <p className="text-3xl text-gray-200 dark:text-gray-300">আসন্ন ত্রয়োদש জাতীয় সংসদ নির্বাচনে চট্টগ্রাম-২ (ফটিকছড়ি) থেকে, ন্যায় ও ইনসাফের প্রতীক</p>
            <h2 className="text-6xl md:text-8xl font-bold text-white my-4 drop-shadow-lg">দাঁড়িপাল্লা, ইনশাআল্লাহ</h2>
          </motion.div>
          </motion.div>
        </div>
      </section>
